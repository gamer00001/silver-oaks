...
import { addTours } from "@/store/actions";
...
const ToursCreate = () => {
  ...
  const {
    ...
    initialValues: {
      ...
      standardPackagePriceInPKR: "",
      deluxePackagePriceInPKR: "",
      executivePackagePriceInPKR: "",
      standardPackagePriceInUSD: "",
      deluxePackagePriceInUSD: "",
      executivePackagePriceInUSD: "",
      ...
      priceOfKidInPKR: "",
      priceOfKidInUSD: "",
      pickupFromLahorePriceInPKR: "",
      pickupFromLahorePriceInUSD: "",
      privateRoomPriceInPKR: "",
      privateRoomPriceInUSD: "",
    },
    ...
    onSubmit: (v) => {
      ...
      dispatch(
        imageUpload({
          payload: { images: [c.featureImage, c.mapImage, c.dayToDayItinerary.img] },
          onSuccess: ({ files: [featureImage, mapImage, dayToDayItineraryImg] }) => {
            dispatch(
              fileUpload({
                ...
                onSuccess: ({ files: [itineraryFile] }) => {
                  ...
                  c.dayToDayItinerary.img = dayToDayItineraryImg;
                  dispatch(
                    addTours({
                      payload: { data: c },
                      onSuccess: () => {
        ...
        <div className="grid gap-[3.3rem] content-start max-w-[1240px]">
          ...
          >
            ...
            <MyInput
              ...
              type="file"
              value={values.itineraryFile && PDFImage}
