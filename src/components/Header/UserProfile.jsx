...
const UserProfile = () => {
    ...
    return (
      <>
        <div
          className="grid gap-[2.7rem] grid-cols-[auto_auto] items-center justify-between cursor-pointer"
        >
            <NavLink
          to={'/notifications'}
         >
          ...
          {/* <span onClick={(e) => setAnchorEl(e.currentTarget)} className="body-medium !font-semibold text-black capitalize max-w-[20rem] overflow-hidden text-ellipsis whitespace-nowrap">
